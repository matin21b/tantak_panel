        ...
        <v-row>
          ...
          <v-col cols="12">
            <v-card class="pa-5">
              ...
              >
                <v-spacer></v-spacer>
                <v-avatar size="65" class="mx-2">
                  <img contain :src="$getImage(selected_product.img)" />
                </v-avatar>
                <div>
                  <h1 class="font_12">
                    قیمت محصول :‌
                  ...
                  <div class="d-flex align-center mt-2">
                    <v-chip small @click="actionNumber(selected_product, true)">
                      +
                    </v-chip>
                    <small class="mx-1">
                      {{ selected_product.number }}
                    ...
                    <v-chip
                      small
                      :disabled="selected_product.number == 0"
                      @click="actionNumber(selected_product, false)"
                    >
                      -
                    </v-chip>
                  </div>
