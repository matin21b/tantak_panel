    ...
    <div class="mt-3">
        <v-row class="d-flex justify-center">
            <v-col cols="12" md="12">
                ...
                <v-autocomplete clearable v-model="gater" :items="geter_list" prepend-inner-icon="mark_email_read" dense
                    outlined label="گیرنده">
                    <template v-slot:item="data">
                        <v-list-item-content>
                            <v-list-item-title>
                                <h1>
                ...
                <v-autocomplete outlined clearable v-model="factor_number" :items="factor_number_list"
                    prepend-inner-icon="description" dense placeholder=" شماره فاکتور مورد نظر را وارد کنید ..."
                    label="شماره فاکتور">
                    <template v-slot:item="data">
                        <v-list-item-content>
                            <v-list-item-title>
                ...
                <amp-button block @click="setFilters"
                    :disabled="!Boolean(sender) && !Boolean(factor_number) && !Boolean(gater)" text="جستوجو" height="38"
            ...
            <amp-button @click="myActivity" text="فعالیت های من" height="38" color="teal darken-1" type="submit"
                icon="event_note" class="ma-1" />
            <amp-button @click="clearAll" text="مشاهده همه" height="38" color="teal darken-1" type="submit"
                icon="filter_alt_off" class="ma-1" />
