<template>
  <v-form v-model="valid" @submit.prevent="submit()">
    ...
    />
    <div class="px-3">
      <amp-labale text="کد ورود"/>
      <!-- <v-otp-input  length="4" v-model="form.code"  class="ltr-item small-input code-input" /> -->
      <v-otp-input  length="4" v-model="form.code" :disabled="!activeLogin"  class="ltr-item small-input code-input" />
    </div>
...
<style >
.code-input div div div div input{
