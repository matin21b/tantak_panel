                  ...
                  <v-row class="d-flex justify-center my-1">
                    <v-col class="" cols="12" md="12">
                      <v-btn
                        ...
                        class="mb-3"
                      >
                        <h1 class="white--text">مهارت های فنی و نرم افزاری</h1>
                        <v-icon color="white" class="mr-6">control_point_duplicate</v-icon>
                      </v-btn>

                      <div
                      v-if="!loading"
                        class="d-flex align-center jsutify-center"
                        v-for="(x, i) in skills_user"
                        :key="i"
                      >
                        <v-col cols="12" md="11" class="pa-0 mr-4">
                          <amp-input
                            :text="'مهارت شماره' + ` ${i + 1}`"
                            v-model="x.text"
                            :placeholder="`${i + 1}`"
                          ></amp-input>
                        </v-col>
                        <v-btn
                          @click="deletItem('skills_user', i)"
                          icon
                          color=" grey"
                        >
                    ...
                    <v-col class="" cols="12" md="12">
                      <v-btn
                        ...
                        class="mb-3"
                      >
                        <h1 class="white--text">تسلط بر زبان های خارجی و میزان تسلط</h1>
                        <v-icon class="mr-6" color="white">control_point_duplicate</v-icon>
                      </v-btn>
                      <v-row class="mt-5">
                        <v-col
                          cols="12"
                        ...
                        >
                          <v-col class="pa-0 mt-5 text-start mr-4" cols="12" md="8">
                            <amp-input
                              v-model="x.lang"
                              :placeholder="`${i + 1}`"
                            ></amp-input>
                          </v-col>
                          <v-col cols="12" md="3" class="pa-0 mt-5">
                            <amp-autocomplete
